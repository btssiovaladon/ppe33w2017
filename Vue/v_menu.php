	...
	<ul>
	   ...
	   <li class='active has-sub'><a href='#'><span>Gestion des actions</span></a>
		  <ul>
			 ...
			 <li class='has-sub'><a href="index.php?controleur=c_action&action=a_incription" title="Inscription AMIS à une activité"><span>Inscrire un AMIS à une action</span></a></li>
